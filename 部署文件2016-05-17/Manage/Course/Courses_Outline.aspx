                ...
                <Columns>
                    <asp:TemplateField HeaderText="课程章节">
                        <ItemTemplate>
                            ...
                            <span class="treeIco">
                                <%# Eval("Tree")%></span> <a href="Courses_Outline.aspx?id=<%= couid %>&olid=<%# Eval("Ol_ID", "{0}")%>"
                                    class="outlineName">
                                    <%# Eval("Ol_Name", "{0}")%></a>
                        </ItemTemplate>
                        <HeaderTemplate>
        ...
        <div loyout="row" overflow="auto">
            <fieldset>
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="2">
                            <Kind:Editor ID="Ol_Intro" runat="server" ThemeType="default" Height="150px"> </Kind:Editor>
                        </td>
                    </tr>
                </table>
            </fieldset>
                    ...
                    <asp:DataList ID="dlVideo" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <ItemTemplate>
                            ...
                            <asp:HyperLink ID="hl" runat="server" NavigateUrl='<%#Eval("As_FileName") %>' Target="_blank"
                                CssClass="video"><%#Eval("As_Name") %></asp:HyperLink>
