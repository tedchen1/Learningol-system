...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <fieldset>
        <legend>考试指南栏目-<asp:Button ID="btnAdd" runat="server" Text="新增栏目" OnClick="btnAdd_Click" /></legend>
        ...
        <cc1:GridView ID="gvColumns" runat="server" AutoGenerateColumns="False" SelectBoxKeyName="SelectBox"
            ...
            <EmptyDataTemplate>
                没有栏目！<br />
                没有栏目依然可以在右侧添加考试指南。<br /><br />
                <a href="GuideContent.aspx?couid=<%=couid %>" class="Gc_Title">[当前课程所有考试指南]</a></span>
            </EmptyDataTemplate>
