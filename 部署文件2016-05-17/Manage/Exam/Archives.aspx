<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Archives.aspx.cs" MasterPageFile="~/Manage/ManagePage.Master"
    Inherits="Song.Site.Manage.Exam.Archives" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <div id="header">
        <div class="searchBox">
            专业：<asp:DropDownList ID="ddlSubject" runat="server">
            </asp:DropDownList>
    ...
    <cc1:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SelectBoxKeyName="SelectBox"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="回顾">
                ...
                <ItemTemplate>
                    <a href="#" onclick="OpenWin('/ExamReview.ashx?id=<%# Eval("Exr_ID")%>&stid=<%# Eval("St_Id")%>','<%# Eval("Exam_Title","考试回顾：《{0}》")%>',980,95);return false;">
                        回顾</a>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="模拟测试">
                ...
                <ItemTemplate>
                    <a href="#" onclick="OpenWin('/testscene.ashx?id=<%# Eval("Tp_ID")%>','<%# Eval("Exam_Title","考试：《{0}》")%>',980,95);return false;">
                        进入测试</a>
                </ItemTemplate>
            </asp:TemplateField>
