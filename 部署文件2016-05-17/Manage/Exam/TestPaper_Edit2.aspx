    ...
    <div class="quesLeft">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                ...
                <td colspan="2">
                    ...
                    &nbsp; <span class="tpType">试卷类型：随机试题</span>
                </td>
            </tr>
            <tr>
                <td class="right">
            ...
            <tr>
                ...
                <td width="200" rowspan="7" valign="top" style="text-align: right">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                ...
                <td>
                    （字数：<span class="count"></span>）
                </td>
            </tr>
        </table>
        <Kind:Editor ID="tbIntro" runat="server" Height="150px" ThemeType="simple" Width="99%"
