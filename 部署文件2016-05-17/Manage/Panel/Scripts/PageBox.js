...
PageBox.prototype.BuildFrame = function () {
    ...
    if (bro.msie) {
        if (bro.version == "6.0") {
            ...
            var iframe = "<iframe id=\"PageBoxIframeTemp\" src=\"/manage/panel/loading.html\" ></iframe> ";
            $("body").append(iframe);
            var frame = $("#PageBoxIframeTemp");
            //设置窗口的位置
...
//关闭窗口
PageBox.prototype.Close = function () {	//清除窗口
    $("#PageBox").remove();
    $("#PageBoxMask").remove();
    //判断浏览器
    var bro = $.browser;
...
PageBox.prototype.Mask = function () {
    $("body").append("<div id=\"PageBoxMask\"/>");
    var mask = $("#PageBoxMask");
    //屏幕的宽高
