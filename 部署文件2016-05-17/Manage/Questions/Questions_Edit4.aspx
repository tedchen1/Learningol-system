...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <div class="quesLeft">
        ...
        <Kind:Editor ID="tbTitle" runat="server" Height="180px" ThemeType="simple" Width="99%"
        ...
        <div class="answerBox">
            <div style="height: 25px; width: 80px; text-align: right; line-height: 25px;float:left ">
                答案：</div><div class="answerNum">（字数：<span class="anscount"></span>）</div>
                 <Kind:Editor ID="tbAnswer" runat="server" Height="200px" ThemeType="simple" Width="99%"
            afterChange="function(){K('.anscount').html(this.count('text'))}"></Kind:Editor>
        </div>
    </div>
    <div class="quesRight">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tbKnsName" runat="server" Width="120"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="right">
                    资料名称：</td>
