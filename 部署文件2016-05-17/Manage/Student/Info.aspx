...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td>
                <asp:TextBox ID="St_Name" nullable="false" pinyin="St_Pinyin" Width="60" MaxLength="6"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="St_AccName" runat="server" Width="120" MaxLength="5" Enabled=false></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="right">
            ...
            <td>
                <asp:TextBox ID="St_Pinyin" runat="server" Width="60" MaxLength="5"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="right">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="St_Birthday" runat="server" onfocus="WdatePicker()" Width="100" CssClass="Wdate" EnableTheming="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="right">
            ...
            <td>
                <asp:TextBox ID="St_IDCardNumber" runat="server" Enabled=false></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="right">
        ...
        <tr>
            ...
            <td colspan="2">
                <Kind:Editor ID="St_Intro"  runat="server" Height="250px" Width="99%" 
                    ThemeType="mini"></Kind:Editor>
            </td>
        </tr>
        <tr>
            <td class="right">
