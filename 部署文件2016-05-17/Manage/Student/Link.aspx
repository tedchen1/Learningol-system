        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="St_Phone" runat="server" datatype="tel"></asp:TextBox>&nbsp;<asp:CheckBox
                    ID="St_IsOpenPhone" runat="server" Text="公开" />
            </td>
        </tr>
        <tr>
            <td class="right">
            ...
            <td>
                <asp:TextBox ID="St_PhoneMobi" runat="server" datatype="mobile"></asp:TextBox>&nbsp;<asp:CheckBox
                    ID="St_IsOpenMobi" runat="server" Text="公开" />
            </td>
        </tr>
        <tr>
            <td class="right">
