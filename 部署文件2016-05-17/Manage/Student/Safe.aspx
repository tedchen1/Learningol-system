  ...
  <asp:Label ID="lbShow" runat=server Text="原密码不正确" Visible=False ForeColor="Red"></asp:Label>
    ...
    <fieldset>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox nullable="false" ID="St_Qus"  group="ques" runat="server" Width="200" MaxLength="100"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox nullable="false" ID="St_Anwser" group="ques" runat="server"  Width="200" MaxLength="100"></asp:TextBox>
            </td>
        </tr>
