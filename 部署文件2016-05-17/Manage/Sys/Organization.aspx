...
<a href="#" class="adminState" orgid="<%# Eval("Org_ID") %>" orgname="<%# Eval("Org_Name")%>"><%# GetAdminState(Eval("Org_ID"))%></a>
</itemtemplate>
            </asp:TemplateField>
...
<cc1:StateButton id="sbPass" onclick="sbPass_Click" runat="server" TrueText="通过" FalseText="待审核" State='<%# Eval("Org_IsPass","{0}")=="True"%>'></cc1:StateButton> 
            ...
            <asp:TemplateField HeaderText="默认">
                <itemstyle cssclass="center" width="60px" />
                <itemtemplate>
<cc1:StateButton id="sbDefualt" onclick="sbDefault_Click" runat="server" TrueText="默认机构" FalseText="普通" State='<%# Eval("Org_IsDefault","{0}")=="True"%>'></cc1:StateButton> 
</itemtemplate>
            </asp:TemplateField>
        </Columns>
    </cc1:GridView>
