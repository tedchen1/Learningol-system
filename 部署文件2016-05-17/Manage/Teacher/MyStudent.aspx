        ...
        <Columns>
          ...
          <asp:TemplateField HeaderText="性别">
            ...
            <asp:TemplateField HeaderText="详情">
                <ItemStyle CssClass="center"  />
                <ItemTemplate>
                    <a href="#" onclick="OpenWin('MyStudent_Online.aspx?stid=<%# Eval("St_ID")%>',' <%# Eval("St_Name")%>的在线时间',980,80);return false;">在线时间</a>
                    <a href="#" onclick="OpenWin('StudyLog_Details.aspx?couid=<%=couid %>&stid=<%# Eval("St_ID")%>',' <%# Eval("St_Name")%>的学习情况',980,80);return false;">学习情况</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </cc1:GridView>
