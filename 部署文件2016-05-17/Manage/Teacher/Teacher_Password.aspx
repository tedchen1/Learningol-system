...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
            ...
            <td>
                <asp:TextBox ID="tbAcc" runat="server" Width="100" nullable="false" group="acc" ></asp:TextBox>
                <asp:CustomValidator
                    ID="cusv" runat="server" ControlToValidate="tbAcc" Display="Dynamic"
         ...
         <tr>
            ...
            <td>
                <asp:Button ID="btnAcc"  verify="true" group="acc" runat="server" Text="修改账号" 
        ...
        <tr>
          ...
          <tr>
            ...
            <td>
                <asp:Button ID="btnPw" verify="true" group="pw" runat="server" Text="重置密码" 
                    onclick="btnPw_Click" />
            </td>
        </tr>
    </table>
