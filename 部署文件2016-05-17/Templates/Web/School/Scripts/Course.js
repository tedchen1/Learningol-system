...
//选项目切换
function tabEvent(){
    var first=$("div[elem=tab][tabtype=title]:first");
    var target=first.attr("target");
    var name=first.attr("name");
    $("div[elem=tab][tabtype=box][name="+name+"]").hide();
    $("div[elem=tab][tabtype=title]").removeClass("titOver");
    //显示当前
    first.addClass("titOver");
    $("div[elem=tab][tabtype=box][name="+name+"][target="+target+"]").show();
    $("div[elem=tab][tabtype=title]").click(function(){
