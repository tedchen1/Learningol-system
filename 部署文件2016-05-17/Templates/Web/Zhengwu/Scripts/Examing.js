...
$(document).ready(function () {
    $().FloatBox("#pagerTitle", "center", -490, 2, 285);
    $().FloatBox("#pagerCard", "center", 230, { target: "#pagerTitle", top: 50 }, 340);
});
*/
//
$(function () {
...
function setCardQues() {
    ...
    tit.find("div.quesType").click(function () {
        ...
        box.scrollTop(off.top - boxoff.top - 10);
